//
//  TrendingUsersViewController+Bind.swift
//  SWHub
//
...
extension TrendingUsersViewController {
    
    func bind(reactor: TrendingUsersViewReactor) {
        super.bind(reactor: reactor)
        self.toAction(reactor: reactor)
        self.fromState(reactor: reactor)
    }
    
    func toAction(reactor: TrendingUsersViewReactor) {
        Observable.merge([
    ...
    func fromState(reactor: TrendingUsersViewReactor) {

...
class RepoDetailCell: BaseCollectionCell, ReactorKit.View {
    ...
    lazy var descLabel: UILabel = {
        let label = UILabel.init()
        label.numberOfLines = SWHub.Metric.DetailCell.maxLines
    ...
    lazy var avatarImageView: UIImageView = {
        ...
        imageView.sizeToFit()
        imageView.size = SWHub.Metric.DetailCell.avatarSize
        return imageView
    }()
    ...
    override func layoutSubviews() {
        ...
        self.avatarImageView.left = SWHub.Metric.DetailCell.margin.left
        self.avatarImageView.top = SWHub.Metric.DetailCell.margin.top
        self.updateLabel.sizeToFit()
        self.updateLabel.left = self.avatarImageView.right + SWHub.Metric.DetailCell.padding.horizontal
        ...
        self.nameLabel.extendToRight = self.contentView.width - SWHub.Metric.DetailCell.margin.right
        self.nameLabel.extendToBottom = self.langLabel.top
        self.descLabel.sizeToFit()
        self.descLabel.width = self.contentView.width - SWHub.Metric.DetailCell.margin.horizontal
    ...
    override class func size(width: CGFloat, item: BaseCollectionItem) -> CGSize {
        ...
        height += UILabel.size(
            ...
            withConstraints: .init(
                width: width - SWHub.Metric.DetailCell.margin.horizontal,
                height: .greatestFiniteMagnitude
            ),
            limitedToNumberOfLines: UInt(SWHub.Metric.DetailCell.maxLines)
        ).height
        height += SWHub.Metric.DetailCell.margin.vertical
        height += SWHub.Metric.DetailCell.avatarSize.height
        height += 15

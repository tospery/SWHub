...
class RepoBasicCell: BaseCollectionCell, ReactorKit.View {
    ...
    lazy var avatarImageView: UIImageView = {
        ...
        imageView.size = SWHub.Metric.BasicCell.avatarSize
        return imageView
    }()
    ...
    override func layoutSubviews() {
        ...
        self.avatarImageView.left = SWHub.Metric.BasicCell.margin.left
        self.avatarImageView.top = SWHub.Metric.BasicCell.margin.top
        self.langLabel.sizeToFit()
        self.langLabel.left = self.avatarImageView.right + SWHub.Metric.BasicCell.padding.horizontal
        self.langLabel.bottom = self.avatarImageView.bottom - 2
        self.forksLabel.sizeToFit()
        self.forksLabel.width = SWHub.Metric.BasicCell.forksWidth
        ...
        self.nameLabel.extendToRight = self.contentView.width - SWHub.Metric.BasicCell.margin.right
        ...
        self.descLabel.extendToRight = self.contentView.width - SWHub.Metric.BasicCell.margin.right
    ...
    override class func size(width: CGFloat, item: BaseCollectionItem) -> CGSize {
        .init(width: width, height: SWHub.Metric.BasicCell.height)
    }

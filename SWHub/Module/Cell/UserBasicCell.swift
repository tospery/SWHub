...
class UserBasicCell: BaseCollectionCell, ReactorKit.View {
    ...
    override func layoutSubviews() {
        ...
        self.userLabel.left = self.avatarImageView.right + SWHub.Metric.BasicCell.padding.horizontal
        self.userLabel.top = self.avatarImageView.top
        self.userLabel.extendToRight = self.contentView.width - SWHub.Metric.BasicCell.margin.right
        ...
        self.descLabel.width = self.contentView.width - SWHub.Metric.BasicCell.margin.horizontal

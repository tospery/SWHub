...
struct R: Rswift.Validatable {
  ...
  struct entitlements {
    struct comAppleDeveloperAssociatedDomains {
      static let applinksSwhubCom = infoPlistString(path: ["com.apple.developer.associated-domains"], key: "applinks:swhub.com") ?? "applinks:swhub.com"
      static let webcredentialsSwhubCom = infoPlistString(path: ["com.apple.developer.associated-domains"], key: "webcredentials:swhub.com") ?? "webcredentials:swhub.com"
  ...
  struct string {
    ...
    struct localizable {
      ...
      /// en translation: Privacy Statement: SWHub will not collect any information from your GitHub account. I don't even have a server. Please feel free to use it.
      ///
      /// Locales: en, zh-Hans
